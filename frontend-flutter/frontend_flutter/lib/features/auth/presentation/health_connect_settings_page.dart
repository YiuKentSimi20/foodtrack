...
class HealthConnectSettingsPage extends StatefulWidget {
  ...
  @override
  State<HealthConnectSettingsPage> createState() => _HealthConnectSettingsPageState();
}
...
class _HealthConnectSettingsPageState extends State<HealthConnectSettingsPage> {
  ...
  Future<void> _syncNow() async {
    ...
    try {
       List<Map<String, dynamic>> healthData = await _healthConnectService.syncHistoricalData(daysBack: 30);
        ...
        children: [
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: const [
                          Text('Sincronizare Health Connect', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
                          SizedBox(height: 4),
                          Text('Importă pași și calorii arse automat', style: TextStyle(fontSize: 12, color: Colors.grey)),
                        ],
                      ),
            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Ultima sincronizare', style: TextStyle(fontSize: 12, color: Colors.grey)),
          ...
          const Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Despre', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                SizedBox(height: 8),
                Text(
