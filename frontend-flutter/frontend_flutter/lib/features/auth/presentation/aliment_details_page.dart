...
import 'package:frontend_flutter/features/auth/models/detalii_aliment_response.dart';
import 'package:frontend_flutter/features/auth/presentation/widgets/macro_ring.dart';
import 'package:frontend_flutter/features/auth/presentation/widgets/nutrition_table.dart';
...
import '../models/aliment_dto.dart'; // aliment dto used to build request
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: score?.color.withOpacity(0.10) ?? Colors.grey.withOpacity(0.10),
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(color: score?.color ?? Colors.grey, width: 1.5),
                                ),
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    Text(
                                      'Nutri-Score ${score?.label ?? '-'}',
                                      style: TextStyle(
                                        color: score?.color ?? Colors.grey,
