...
import 'package:frontend_flutter/features/auth/presentation/register_measurements_page.dart';
import 'package:frontend_flutter/features/auth/presentation/widgets/app_date_picker_field.dart';
...
class _RegisterAccountPageState extends State<RegisterAccountPage> {
  ...
  final Map<String, String> _activityLabels = {
    'SEDENTAR': 'Sedentar (foarte puțină mișcare)',
    'MAI_PUTIN_ACTIV': 'Mai puțin activ (plimbări ocazionale)',
    'ACTIV': 'Activ (antrenament regulat)',
    'FOARTE_ACTIV': 'Foarte activ (antrenamente intense)',
  };
  ...
  Future<void> _continue() async {
    ...
    debugPrint(_birthDateValue.toString());
    try {
