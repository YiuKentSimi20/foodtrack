          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  await _repo.createGrasime(procent: v, dataMasuratoare: selected);
      ...
      body: _loading
        ...
        child: Column(
          children: [
            Card(
              child: ListTile(
                leading: const CircleAvatar(child: Icon(Icons.percent_outlined)),
            ...
            Expanded(
              child: _history.isEmpty
                ...
                itemBuilder: (_, i) {
                  final m = _history[i];
                  return ListTile(
                    title: Text('${m.procent.toStringAsFixed(1)} %'),
